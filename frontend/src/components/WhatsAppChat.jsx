                            ...
                            <span className={`tick-mark ${msg.status}`}>
                              ...
                              {(msg.status === 'delivered' || msg.status === 'read') && (
                                <svg viewBox="0 0 16 15" width="16" height="15" fill={msg.status === 'read' ? '#53bdeb' : 'currentColor'}>
                                  <path d="m15.01 3.316-8.316 8.316L2.651 7.59l1.06-1.06 3.082 3.083 7.263-7.263.954 1.166zM10.81 2.15l3.166 3.165-1.06 1.06-2.106-2.105L10.81 2.15zm-6.04 8.42L2.651 8.451l-1.06 1.06 3.179 3.179 1.41-1.41-1.41-1.41z"></path>
                                </svg>
                              )}
                            </span>
                          )}
