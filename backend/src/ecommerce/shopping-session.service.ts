...
interface ShoppingSession {
  ...
  step: 'browsing' | 'buying' | 'details' | 'awaiting_name' | 'awaiting_address' | 'awaiting_city' | 'awaiting_pincode' | 'awaiting_payment_method' | 'confirm_details' | 'select_update_field' | 'awaiting_flow_response';
  customerName?: string;
